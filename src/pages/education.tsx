            ...
            <div className="mt-36 flex w-full flex-col">
              ...
              <div className="pane">
                ...
                <div className="pane">
                  ...
                  <div className="prose prose-lg w-5/6 pt-2 text-left tracking-tight dark:prose-invert md:prose-xl lg:prose-2xl md:w-2/5 md:pt-12">
                    <h6>
                      Research and analyze global economic trends and financial
                      ...
                      <div className="ml-6">
                        ...
                        <li>
                          Collaborate with club members to facilitate
                          discussions on international trade, monetary policy,
                          and market dynamics, enhancing collective
                          understanding.
                        </li>
                      </div>
                    </h6>
                    ...
                    <h6>
                      ...
                      <div className="ml-6">
                        <li>
                          ...
                          monitors vital signs and alerts healthcare providers
                          of any anomalies, demonstrating a deep understanding
                          of both hardware and software design principles.
                        </li>
                        <li>
