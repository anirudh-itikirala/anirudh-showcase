...
const defaultMeta = {
  title: 'Anirudh Itikirala',
  siteName: 'Anirudh Itikirala',
  description: "Anirudh Itikirala's portfolio, a fullstack expression!",
  url: 'https://anirudh-showcase.vercel.app',
  type: 'website',
  robots: 'follow, index',
